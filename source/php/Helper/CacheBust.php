...
namespace ModularityLottieFiles\Helper;
...
class CacheBust
{
    ...
    {
        $jsonPath = MODULARITYLOTTIEFILES_PATH . apply_filters(
            'ModularityLottieFiles/Helper/CacheBust/RevManifestPath',
            'dist/manifest.json'
        );
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITYLOTTIEFILES_PATH . ' and run gulp. See ' . MODULARITYLOTTIEFILES_PATH . 'README.md for more info.</div>';
        }
